...
const adminSettings = [
  { _id: 'settings-organization', key: 'organization', category: 'organization',
    value: { platformName: 'ClinicTrust AI', orgName: 'ClinicTrust Health Network',
      supportEmail: 'support@clinictrust.ai', contactPhone: '+1 (555) 123-4567',
      platformUrl: 'https://app.clinictrust.ai', timezone: 'America/New_York',
      dateFormat: 'MM/DD/YYYY', workStart: '08:00', workEnd: '18:00',
      address: '123 Healthcare Blvd, New York, NY 10001' } },
  { _id: 'settings-security', key: 'security', category: 'security',
    value: { minPasswordLen: 10, requireUppercase: true, requireNumbers: true,
      requireSpecialChars: true, passwordExpiryDays: 90,
      maxLoginAttempts: 5, lockoutMinutes: 15, sessionTimeoutMinutes: 30,
      enforceMFA: false, requireHIPAAAgreement: true, ipAllowlistEnabled: false, auditAllActions: true } },
  { _id: 'settings-notifications', key: 'notifications', category: 'notifications',
    value: { emailEnabled: true, smsEnabled: false, newReferral: true, referralAccepted: true,
      referralCompleted: true, paApproved: true, paDenied: true, kycStatusUpdate: true,
      tokenEarned: false, lowTokenBalance: true, lowBalanceThreshold: 100,
      systemAlerts: true, dailyDigest: false, digestTime: '08:00' } },
  { _id: 'settings-integrations', key: 'integrations', category: 'integrations',
    value: { fhirEndpoint: 'https://fhir.clinictrust.ai/r4', ehrSystem: 'Epic',
      ehrApiKey: '', ehrApiEndpoint: 'https://api.epic.com/FHIR/R4',
      webhookUrl: 'https://hooks.clinictrust.ai/events', webhookSecret: '',
  ...
  { _id: 'settings-maintenance', key: 'maintenance', category: 'maintenance',
    value: { maintenanceMode: false,
      maintenanceMessage: 'The platform is undergoing scheduled maintenance. We will be back shortly.',
      autoBackup: true, backupFrequency: 'daily', backupRetentionDays: 30,
      dataRetentionMonths: 84, auditLogRetentionMonths: 84,
      maxUploadMB: 10, debugLogging: false, allowPublicRegistration: true } },
];
